...
class LoanEnvironment(gym.Env):
    ...
    def __init__(self, X, y, sensitive, fairness_penalty=0.0):
    ...
    def reset(self):
        ...
        if hasattr(self.X, 'toarray'):
            self.current_state = self.X[self.current_idx].toarray().flatten()
        else:
    ...
    def step(self, action):
        ...
        # Return current state (sparse matrices already handled in reset)
